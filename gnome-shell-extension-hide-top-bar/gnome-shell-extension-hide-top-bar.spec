...
# 源代码仓库 https://github.com/Tudmotu/gnome-shell-extension-clipboard-indicator
# git clone --depth=1 https://github.com/Tudmotu/gnome-shell-extension-clipboard-indicator.git
# ==============================================================================
...
%global uuid hidetopbar@mathieu.bidon.ca

# ==============================================================================
# 2. 包基本信息 (Header)
# ==============================================================================
# 包的名称。通常与扩展名或项目名一致。
Name:           gnome-shell-extension-hide-top-bar
# 版本号。
...
# https://gitlab.gnome.org/tuxor1337/hidetopbar/-/archive/extensions.gnome.org-124/hidetopbar-extensions.gnome.org-124.zip
Source0:        %{url}/-/archive/extensions.gnome.org-%{version}/hidetopbar-extensions.gnome.org-%{version}.zip
...
# 🔑 关键：从嵌套目录复制，而不是当前目录
cp -r -p hidetopbar-extensions.gnome.org-%{version}/* \
...
# ==============================================================================
# 1. 将 spec 文件放到正确位置
# cp gnome-shell-extension-hide-top-bar.spec ~/rpmbuild/SPECS/
# 2. 进入 SPECS 目录
# cd ~/rpmbuild/SPECS/
# 🔍 检查 spec 语法
# rpmlint ~/rpmbuild/SPECS/gnome-shell-extension-hide-top-bar.spec
# 3. 下载源码到 SOURCES（spectool 会自动处理 Source0/1/2）
# spectool -g -R gnome-shell-extension-hide-top-bar.spec
# ✅ 验证源码是否下载成功
# ls -lh ~/rpmbuild/SOURCES/ | grep add-to-desktop
# 4. 生成 SRPM（源码 RPM）
# rpmbuild -bs gnome-shell-extension-hide-top-bar.spec
# ✅ 查看生成的 SRPM
# ls -lh ~/rpmbuild/SRPMS/
# 输出示例: gnome-shell-extension-add-to-desktop-16-1.fc44.src.rpm
# 5. 直接生成本地 RPM
# rpmbuild -bb gnome-shell-extension-hide-top-bar.spec
...
# 安装测试
# sudo dnf install -y ~/rpmbuild/RPMS/noarch/gnome-shell-extension-hide-top-bar-124-1.fc44.noarch.rpm
# sudo dnf remove -y gnome-shell-extension-hide-top-bar

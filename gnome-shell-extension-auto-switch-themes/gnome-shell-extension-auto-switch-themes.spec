...
# 源代码仓库 https://github.com/fthx/appmenu-is-back
# git clone --depth=1 https://github.com/fthx/appmenu-is-back.git
# ==============================================================================
...
%global uuid appmenu-is-back@fthx

# ==============================================================================
# 2. 包基本信息 (Header)
# ==============================================================================
# 包的名称。通常与扩展名或项目名一致。
Name:           gnome-shell-extension-auto-switch-themes
# 版本号。
...
# https://github.com/fthx/appmenu-is-back/archive/refs/tags/v12.zip
...
# ==============================================================================
# 1. 将 spec 文件放到正确位置
# cp gnome-shell-extension-auto-switch-themes.spec ~/rpmbuild/SPECS/
# 2. 进入 SPECS 目录
# cd ~/rpmbuild/SPECS/
# 🔍 检查 spec 语法
# rpmlint ~/rpmbuild/SPECS/gnome-shell-extension-auto-switch-themes.spec
# 3. 下载源码到 SOURCES（spectool 会自动处理 Source0/1/2）
# spectool -g -R gnome-shell-extension-auto-switch-themes.spec
# ✅ 验证源码是否下载成功
# ls -lh ~/rpmbuild/SOURCES/ | grep add-to-desktop
# 4. 生成 SRPM（源码 RPM）
# rpmbuild -bs gnome-shell-extension-auto-switch-themes.spec
# ✅ 查看生成的 SRPM
# ls -lh ~/rpmbuild/SRPMS/
# 输出示例: gnome-shell-extension-add-to-desktop-16-1.fc44.src.rpm
# 5. 直接生成本地 RPM
# rpmbuild -bb gnome-shell-extension-auto-switch-themes.spec

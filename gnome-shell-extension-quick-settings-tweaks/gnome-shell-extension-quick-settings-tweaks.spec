...
# 源代码仓库 https://github.com/qwreey/quick-settings-tweaks
# git clone --depth=1 https://github.com/qwreey/quick-settings-tweaks.git
# ==============================================================================
...
# ==============================================================================
# 包的名称。通常与扩展名或项目名一致。
Name:           gnome-shell-extension-quick-settings-tweaks
# 版本号。
...
Release:        1%{?dist}
# 简短描述。出现在软件中心的列表中。
Summary:        Let's tweak gnome Quick Settings! You can add Media Controls, Notifications, Volume Mixer on quick settings and remove useless buttons!
...
# https://github.com/qwreey/quick-settings-tweaks/archive/refs/heads/master.zip
...
# ==============================================================================
# 1. 将 spec 文件放到正确位置
# cp gnome-shell-extension-quick-settings-tweaks.spec ~/rpmbuild/SPECS/
# 2. 进入 SPECS 目录
# cd ~/rpmbuild/SPECS/
# 🔍 检查 spec 语法
# rpmlint ~/rpmbuild/SPECS/gnome-shell-extension-quick-settings-tweaks.spec
# 3. 下载源码到 SOURCES（spectool 会自动处理 Source0/1/2）
# spectool -g -R gnome-shell-extension-quick-settings-tweaks.spec
# ✅ 验证源码是否下载成功
# ls -lh ~/rpmbuild/SOURCES/ | grep add-to-desktop
# 4. 生成 SRPM（源码 RPM）
# rpmbuild -bs gnome-shell-extension-quick-settings-tweaks.spec
# ✅ 查看生成的 SRPM
# ls -lh ~/rpmbuild/SRPMS/
# 5. 直接生成本地 RPM
# rpmbuild -bb gnome-shell-extension-quick-settings-tweaks.spec
# 生成的 RPM 位置
# ls -lh ~/rpmbuild/RPMS/noarch/
# 安装测试
# sudo dnf install -y ~/rpmbuild/RPMS/noarch/gnome-shell-extension-quick-settings-tweaks-*.fc44.noarch.rpm
# sudo dnf remove -y gnome-shell-extension-quick-settings-tweaks

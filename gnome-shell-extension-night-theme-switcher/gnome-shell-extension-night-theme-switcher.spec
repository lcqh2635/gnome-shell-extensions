...
# 源代码仓库 https://gitlab.com/rmnvgr/nightthemeswitcher-gnome-shell-extension
...
%global uuid nightthemeswitcher@romainvigier.fr
...
Release:        1%{?dist}
# 简短描述。出现在软件中心的列表中。
Summary:        Make your GNOME desktop easy on the eye, day and night
...
# https://gitlab.com/rmnvgr/nightthemeswitcher-gnome-shell-extension/-/releases/82/downloads/nightthemeswitcher.zip
Source0:        %{url}/-/releases/%{version}/downloads/nightthemeswitcher.zip
...
# ==============================================================================
%description
Make your GNOME desktop easy on the eye, day and night
...
# ==============================================================================
# 1. 将 spec 文件放到正确位置
# cp gnome-shell-extension-night-theme-switcher.spec ~/rpmbuild/SPECS/
# 2. 进入 SPECS 目录
# cd ~/rpmbuild/SPECS/
# 🔍 检查 spec 语法
# rpmlint ~/rpmbuild/SPECS/gnome-shell-extension-night-theme-switcher.spec
# 3. 下载源码到 SOURCES（spectool 会自动处理 Source0/1/2）
# spectool -g -R gnome-shell-extension-night-theme-switcher.spec
# ✅ 验证源码是否下载成功
# ls -lh ~/rpmbuild/SOURCES/ | grep add-to-desktop
# 4. 生成 SRPM（源码 RPM）
# rpmbuild -bs gnome-shell-extension-night-theme-switcher.spec
# ✅ 查看生成的 SRPM
# ls -lh ~/rpmbuild/SRPMS/
# 5. 直接生成本地 RPM
# rpmbuild -bb gnome-shell-extension-night-theme-switcher.spec
# 生成的 RPM 位置
# ls -lh ~/rpmbuild/RPMS/noarch/
# 安装测试
# sudo dnf install -y ~/rpmbuild/RPMS/noarch/gnome-shell-extension-night-theme-switcher-*.fc44.noarch.rpm
# sudo dnf remove -y gnome-shell-extension-night-theme-switcher

...
# 源代码仓库 https://github.com/ddterm/gnome-shell-extension-ddterm
# git clone --depth=1 https://github.com/ddterm/gnome-shell-extension-ddterm.git
# ==============================================================================
...
%global uuid ddterm@amezin.github.com
...
Release:        1%{?dist}
# 简短描述。出现在软件中心的列表中。
Summary:        Another drop down terminal extension for GNOME Shell. With tabs. Works on Wayland natively
...
# https://github.com/ddterm/gnome-shell-extension-ddterm/releases/download/v63.0.0/ddterm@amezin.github.com.shell-extension.zip
Source0:        %{url}/releases/download/v63.0.0/%{uuid}.shell-extension.zip
...
# ==============================================================================
# 1. 将 spec 文件放到正确位置
# cp gnome-shell-extension-ddterm.spec ~/rpmbuild/SPECS/
# 2. 进入 SPECS 目录
# cd ~/rpmbuild/SPECS/
# 🔍 检查 spec 语法
# rpmlint ~/rpmbuild/SPECS/gnome-shell-extension-ddterm.spec
# 3. 下载源码到 SOURCES（spectool 会自动处理 Source0/1/2）
# spectool -g -R gnome-shell-extension-ddterm.spec
# ✅ 验证源码是否下载成功
# ls -lh ~/rpmbuild/SOURCES/ | grep add-to-desktop
# 4. 生成 SRPM（源码 RPM）
# rpmbuild -bs gnome-shell-extension-ddterm.spec
# ✅ 查看生成的 SRPM
# ls -lh ~/rpmbuild/SRPMS/
# 输出示例: gnome-shell-extension-add-to-desktop-16-1.fc44.src.rpm
# 5. 直接生成本地 RPM
# rpmbuild -bb gnome-shell-extension-ddterm.spec
...
# 安装测试
# sudo dnf install -y ~/rpmbuild/RPMS/noarch/gnome-shell-extension-desktop-icons-ng-50-1.fc44.noarch.rpm

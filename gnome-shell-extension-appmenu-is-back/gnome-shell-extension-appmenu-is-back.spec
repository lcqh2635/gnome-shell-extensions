...
# 源代码仓库 https://github.com/Tommimon/add-to-desktop
# git clone --depth=1 https://github.com/Tommimon/add-to-desktop.git
# ==============================================================================
...
# ==============================================================================
# 包的名称。通常与扩展名或项目名一致。
Name:           gnome-shell-extension-appmenu-is-back
# 版本号。
